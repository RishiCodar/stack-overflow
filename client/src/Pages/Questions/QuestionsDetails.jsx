...
import { postAnswer, deleteQuestion, voteQuestion, postComment} from "../../actions/question";
...
const QuestionsDetails = () => {
  ...
  const url = "https://stackoverflow-byrishi.netlify.app";
            ...
            .map((question) => (
              <div key={question._id}>
                ...
                <section className="post-ans-container">
                  ...
                  <form
                    onSubmit={(e) => {
                      handlePostComment(e, question.comment.length);
                    }}
                  >
                    <textarea
                      name=""
